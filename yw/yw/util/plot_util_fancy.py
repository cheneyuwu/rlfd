...
from yw.util.reader_util import read_json, read_csv
...
def load_results(root_dir_or_dirs, enable_progress=True, enable_monitor=False, verbose=True):
    """
    load summaries of runs from a list of directories (including subdirectories)

    Arguments:
    enable_progress: bool - if True, will attempt to load data from progress.csv files (data saved by logger).
    enable_monitor: bool - if True, will attempt to load data from monitor.csv files (data saved by Monitor environment wrapper).
    verbose: bool - if True, will print out list of directories from which the data is loaded.
...
def plot_results(
    ...
    *,
    ...
    shaded_err: bool                        - if True (default), the shaded region corresponding to error in mean                                                 estimate of the group of curves
                                              (that is, standard deviation divided by square root of number of curves) will be shown (only applicable if average_group = True)

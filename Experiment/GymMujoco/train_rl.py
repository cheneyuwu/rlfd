...
params_config["config"] = "TD3"  # experiments with the same config name will be plotted as 1 line
params_config["env_name"] = ("InvertedPendulum-v2",)  # try also HalfCheetah-v2
params_config["demo_strategy"] = ("none",)  # use "none" for td3, "bc" for rl+bc, "gan" for shaping

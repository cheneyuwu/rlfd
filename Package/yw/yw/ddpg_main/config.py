...
DEFAULT_PARAMS = {
    ...
    # general ddpg config
    "rl_buffer_size": int(1e6),  # for experience replay
    ...
    "rl_prm_loss_weight": 1.0,  # Weight corresponding to the primary loss
    "rl_aux_loss_weight": 1.0,  # Weight corresponding to the auxilliary loss also called the cloning loss
    # Double Q Learning

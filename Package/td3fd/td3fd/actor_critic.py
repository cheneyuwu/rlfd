...
class ActorCritic:
    def __init__(self, dimo, dimg, dimu, max_u, o_stats, g_stats, use_td3, noise, layer_sizes):
        """
        ...
        Args:
            ...
            noise            (bool)         - whether or not to add noise to the policy output
        """
    ...
    def actor(self, o, g):
        ...
        if self.noise:  # for td3, add noise!

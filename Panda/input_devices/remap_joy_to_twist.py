...
class JoyToTwist:
    def __init__(self):
		...
		self.state_sub = rospy.Subscriber("/franka_state_controller/franka_states", FrankaState, self.on_franka_state)
		...
		# Left/Right [-0.4, 0.35]
		self.safety_region = np.array([[0.33, 0.7],[-0.4, 0.35],[0.005, 0.41]])
